...
class TestStatusFor:
    def test_status_for_returns_accepted_for_scan_for_work(
    ...
    def test_status_for_returns_all_operations(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
...
class TestStatusForWrite:
    ...
    def test_status_for_write_succeeds_for_start_development(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_status_for_write_succeeds_for_mark_complete(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_status_for_write_succeeds_for_open_for_review(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_status_for_write_succeeds_for_skip_rejected(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
...
class TestMatches:
    ...
    def test_matches_returns_false_for_different_status(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_matches_strips_whitespace(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
        """matches() strips leading/trailing whitespace before comparing."""
        assert default_workflow_config.matches(WorkflowOperation.SKIP_REJECTED, "  REJECTED  ") is True

    def test_matches_for_scan_for_work(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_matches_returns_false_for_unrelated(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
...
class TestTeamBConfig:
    def test_team_b_config_different_status_names(
        self, team_b_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_team_b_start_development_returns_developing(
        self, team_b_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_team_b_mark_complete_returns_finished(
        self, team_b_workflow_config: WorkflowConfig
    ) -> None:
        assert team_b_workflow_config.status_for_write(WorkflowOperation.MARK_COMPLETE) == "Finished"

    def test_team_b_scan_for_work_still_human_only(
        self, team_b_workflow_config: WorkflowConfig
    ) -> None:
...
class TestTeamCConfig:
    def test_team_c_multi_word_status_names(
        self, team_c_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_team_c_open_for_review_multi_word(
        self, team_c_workflow_config: WorkflowConfig
    ) -> None:
...
class TestIsHumanOnly:
    def test_is_human_only_true_for_scan_for_work(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
    ...
    def test_is_human_only_false_for_start_development(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
        assert default_workflow_config.is_human_only(WorkflowOperation.START_DEVELOPMENT) is False

    def test_is_human_only_false_for_all_write_operations(
        self, default_workflow_config: WorkflowConfig
    ) -> None:
        for op in [
