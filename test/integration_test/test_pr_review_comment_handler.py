...
class TestNoActionWhenNoFeedback:
    def test_no_action_when_approved_and_no_comments(
        self, mock_dev_registry: MagicMock
    ) -> None:
...
class TestDispatchForChangesRequested:
    def test_dispatches_fix_for_changes_requested(
        self, mock_dev_registry: MagicMock
    ) -> None:
...
class TestDispatchForUnresolvedComments:
    def test_dispatches_fix_for_unresolved_inline_comments(
        self, mock_dev_registry: MagicMock
    ) -> None:
...
class TestFixTaskContainsCommentTexts:
    def test_fix_task_includes_all_comment_texts(
        self, mock_dev_registry: MagicMock
    ) -> None:
...
class TestNoSelfApproval:
    def test_fix_task_explicitly_forbids_self_approval(
        self, mock_dev_registry: MagicMock
    ) -> None:
    ...
    def test_fix_task_explicitly_forbids_merge(
        self, mock_dev_registry: MagicMock
    ) -> None:
...
class TestDeduplication:
    ...
    def test_deduplication_guard_cleared_after_fix(
        self, mock_dev_registry: MagicMock
    ) -> None:
